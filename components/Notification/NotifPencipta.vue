<template>
    <div>
        <label class="btn btn-sm gap-2 no-animation w-full" 
            ...
            <tr>
                ...
                <table class="sm-w-full" style="width: 600px" cellpadding="0" cellspacing="0" role="presentation">
                    ...
                    <td class="sm-py-4 sm-px-6" style="padding: 48px; text-align: center">
                        ...
                        <img src="https://upload.wikimedia.org/wikipedia/id/archive/7/73/20171123143356%21Lambang_Universitas_Negeri_Malang.jpg" width="70" alt="Universitas Negeri Malang" style="border: 0; max-width: 100%; vertical-align: middle">
                        </a>
                    </td>
                    </tr>
                    <tr>
                    <td align="center" class="sm-px-6">
                        ...
                        <tr>
                            ...
                            <p style="margin-bottom: 24px">
                                Kami beritahukan bahwa ajuan Hak Cipta berjudul:
                            </p>
                            ...
                            <div style="margin-top: 24px; margin-bottom: 32px; line-height: 100%" v-if="props.data.statusCiptaan != 'Ditolak'">
                                <a href="https://hakciptav2.vercel.app/dashboard" target="_blank" style="text-decoration: none; display: inline-block; border-radius: 4px; background-color: #1d4ed8; padding-left: 16px; padding-right: 16px; padding-top: 14px; padding-bottom: 14px; text-align: center; font-size: 16px; font-weight: 600; color: #fff">
                                <!--[if mso]>
                                    <i style="mso-text-raise: 30px; letter-spacing: 24px">&#8202;</i>
                                <![endif]-->
                                <span style="mso-text-raise: 16px">Dashboard</span>
                                <!--[if mso]>
...
const teksPesan = computed(()=>{
    switch (props.data.statusCiptaan) {
        case 'Revisi':
            return 'Perlu direvisi. Mohon untuk segera melakukan perbaikan pada data tersebut melalui link berikut:'
            break;
        case 'Cetak Formulir':
            return 'Dapat dicetak. Mohon untuk segera mencetak formulir dan melengkapi tanda tangan seluruh pencipta. Setelah itu berkas dapat diserahkan di Sentra HKI (Graha Rektorat UM Lt. 7). Silahkan klik link berikut untuk mencetak formulir:'
            break;
        case 'Ditolak':
            return 'Tidak dapat diproses karena tidak memenuhi syarat dan ketentuan hak cipta.'
            break;
    }
})
...
async function kirimSertifikat(){
    ...
    // open gmail compose
    const targetEmail = ref(props.data.pengusul[0])
    ...
    // empty body
    window.open(`https://mail.google.com/mail/?view=cm&fs=1&to=${targetEmail.value}&su=HAK CIPTA - (${props.data.statusCiptaan})`);
}
